...
def render_report(results):
    ...
    print(f"Website Title: {results.get('Title')}")
    print(f"Meta Description: {results.get('Meta Description')}")
    print(f"Meta Keywords: {results.get('Meta Keywords')}\n")

    # Header tags
    print("Header Tags:")
    for tag, count in results.get('Header Tags', {}).items():
        print(f"  - {tag.upper()}: {count}")
    print()

    # Images
    print("Images:")
    print(f"  - Total Images: {results.get('Total Images')}")
    print(f"  - Images with Alt Text: {results.get('Images with Alt Text')}\n")

    # CSS and JavaScript
    print("CSS and JavaScript:")
    print(f"  - Linked CSS Files: {', '.join(results.get('CSS Files', [])) or 'None'}")
    print(f"  - Linked JavaScript Files: {', '.join(results.get('JavaScript Files', [])) or 'None'}")
    print(f"  - Inline CSS: {results.get('Inline CSS')}")
    print(f"  - Inline JavaScript: {results.get('Inline JS')}\n")

    # Performance and Responsiveness
    print("Performance and Mobile Optimization:")
    print(f"  - Page Load Time: {results.get('Page Load Time (seconds)', 'N/A')} seconds")
    print(f"  - Responsiveness: {results.get('Responsiveness')}")
    print(f"  - Mobile-Friendliness: {results.get('Mobile-Friendliness')}\n")
